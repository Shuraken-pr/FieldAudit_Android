...
Проект покрыт **29 автоматическими модульными тестами** (с обновлённой схемой SQLite, Int64 ID) (с обновлённой схемой SQLite, Int64 ID) на фреймворке **DUnitX** со **100% успешным прохождением**.
