...
| `TTestJpegUtils` | 5 | Сжатие фото, ресайз до 1920px, сохранение пропорций |
...
| Дата | Описание |
|------|----------|
| 2026-06-22 | Обновлена документация: добавлена информация о совместимости с bcrypt-аутентификацией сервера |
| 2026-06-21 | Подключён и успешно запущен `TestJpegUtils.pas` (5 тестов). Итого 29 тестов, 100% прохождение |
